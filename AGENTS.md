...
An RP2354B runs Betaflight against a custom target (`rp2350a` sheet: MCU,
USB-C, 12 MHz crystal, boot button, buzzer and LED-strip FETs). The IMU sits on SPI0 (imu)
